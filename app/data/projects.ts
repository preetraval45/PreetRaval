...
export const projects: Project[] = [
  {
    ...
    highlights: [
      ...
      'Correlates scattered signals across security tools into one incident with traceable, evidence-linked causal chains',
      'Risk-scored response actions weighed by blast radius, confidence, and reversibility before any execution',
